<?php
    ...
    include_once ('../backend/Event.php');

    if(isset($_POST['venue'])){
        $createEvent=new Event();
        $createEvent->venue=$_POST['venue'];
        $createEvent->eventDescription=$_POST['eventDescription'];

        $createEvent->createDate=$_POST['createdDate'];
        $createEvent->conductDate=$_POST['eventConductDate'];
        $createEvent->eventTime=$_POST['eventTime'];

        $eventDetails=$createEvent->create_event();
    }
?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12" style="font-size: 16px;" aria-required="true">
                                    <br>
                                    <input class="" type="checkbox" value="Sim Cards" name="chk['SimCard']"> SIM CARDS<br>
                                    <input class="" type="checkbox" value="4G Routers" name="chk['Router']"> 4G ROUTERS<br>
                                    <input class="" type="checkbox" value="Dialog Tv" name="chk['Dtv']"> DIALOG TV
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <input type="text" class="form-control" name="createdDate" id="createdDate" value="<?php echo date("Y-m-d")?>" readonly>
                            </div>
                        </div>
