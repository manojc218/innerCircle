...
class Product
{
    ...
    public function get_sim()
    {
        ...
        while ($row = $simList->fetch_array()) {
            $newSimList = new Product();
            $newSimList->productId = $row['product_id'];
            $newSimList->serialNumber = $row['serial_number'];
            $newSimList->productCategory = $row['product_c_id'];
            $newSimList->packageName = $row['package_name'];
            $newSimList->productDescription = $row['description'];
            $newSimList->addedDate = $row['added_date'];
